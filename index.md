...
[正确性不是收益](src/2-8.正确性不是收益.md) 一次策略修复在真实回放里的反直觉结果

[策略实验变成工程问题](src/2-9.策略实验变成工程问题.md) 把策略假设、验证设施和上线决策拆开

[回测里的幸存者名单](src/2-10.回测里的幸存者名单.md) 为什么真实 universe 比收益曲线更重要
